...
RSpec.describe GramsController, type: :controller do
  describe "grams#destroy action" do
   ...
   it "shouldn't let unauthenticated users destroy a gram" do
    ...
    it "should return a 404 message if we cannot find a gram with the id" do
      ...
      delete :destroy, params: { id: "SPACEPANTS" }
  ...
  describe "grams#update action" do
    it "shoulnd't let users who didn't create the gram update the gram" do
      gram = FactoryBot.create(:gram)
      user = FactoryBot.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
        it "shoulnd't let a user who did not create the gram edit a gram" do
          gram = FactoryBot.create(:gram)
          user = FactoryBot.create(:user)
          sign_in user
        ...
        it "shouldn't allow unauthenticated users to edit grams" do
          gram = FactoryBot.create(:gram)
          get :edit, params: { id: gram.id }
          expect(response).to redirect_to new_user_session_path
        end

        it "should successfully show the edit form if found" do
          gram = FactoryBot.create(:gram)
          sign_in gram.user
